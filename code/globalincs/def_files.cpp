...
"varying vec3 fragEnvReflect;\n"
"#endif\n"
"#ifdef FLAG_NORMAL_MAP\n"
"varying mat3 fragTangentMatrix;\n"
"#endif\n"
"#ifdef FLAG_FOG\n"
"varying float fragFogDist;\n"
"#endif\n"
...
"varying float geoNotVisible;\n"
"#else\n"
"varying float fragNotVisible;\n"
"#endif\n"
"#endif\n"
"#ifdef FLAG_SHADOW_MAP\n"
"varying float geoInstance;\n"
"uniform mat4 shadow_proj_matrix[4];\n"
"#endif\n"
"#ifdef FLAG_SHADOWS\n"
"uniform mat4 shadow_mv_matrix;\n"
"uniform mat4 shadow_proj_matrix[4];\n"
"varying vec4 fragShadowUV[4];\n"
"varying vec4 fragShadowPos;\n"
"#endif\n"
"#ifdef FLAG_THRUSTER\n"
...
"#ifdef FLAG_SHADOW_MAP\n"
"varying float geoClipDistance;\n"
"#else\n"
"varying float fragClipDistance;\n"
"#endif\n"
"#endif\n"
...
"  #endif\n"
" #endif\n"
"	fragTexCoord = gl_TextureMatrix[0] * vertTexCoord;\n"
...
" #endif\n"
" #ifdef FLAG_FOG\n"
"	fragFogDist = clamp((gl_Position.z - gl_Fog.start) * 0.75 * gl_Fog.scale, 0.0, 1.0);\n"
" #endif\n"
" #ifdef FLAG_CLIP\n"
"   float clip_dist = 0.0;\n"
...
"	gl_FragData[0] = vec4(fragPosition.z, fragPosition.z * fragPosition.z * VARIANCE_SHADOW_SCALE_INV, 0.0, 1.0);\n"
"	return;\n"
"#endif\n" 
...
" #endif\n"
"   baseColor.rgb = mix(baseColor.rgb, fogColor, fragFogDist);\n"
...
" #else\n"
"      baseColor.rgb = mix(texture2D(sFramebuffer, screenPos + distort*anim_timer + anim_timer*0.1*fragNormal.xy).rgb,baseColor.rgb,clamp(cloak_interp+anim_timer*2.0,0.0,1.0));\n"
" #endif\n"
"   }\n"
"#endif\n"
"#ifdef FLAG_CLIP\n"
