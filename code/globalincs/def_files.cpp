...
"}\n"
"vec3 FresnelSchlickEnv(vec3 specColor, vec3 view, vec3 normal, float gloss)\n"
"{\n"
...
"	baseColor.rgb += envColour.rgb * FresnelSchlickEnv(specColour.rgb, eyeDir, normal, glossData);\n"
"#endif\n"
"\n"
"#ifdef FLAG_GLOW_MAP\n"
