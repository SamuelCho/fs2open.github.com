...
" #else\n"
"	position = viewMatrix * modelMatrix * orient * vertex;\n"
" #endif\n"
" #ifdef FLAG_SHADOW_MAP\n"
...
" #else\n"
"	vec3 normal = normalize(mat3(viewMatrix * modelMatrix) * mat3(orient) * gl_Normal);\n"
" #endif\n"
"	lNormal = normal;\n"
" #ifdef FLAG_SHADOWS\n"
...
" #else\n"
"	vec3 t = normalize(mat3(viewMatrix * modelMatrix) * mat3(orient) * gl_MultiTexCoord1.xyz);\n"
" #endif\n"
...
"          dist = distance(lightPosition[i].xyz, position.xyz);\n"
...
"              float neardist = dot(position.xyz - lightPosition[i].xyz , beamDir);\n"
