...
void brief_render_closeup(int ship_class, float frametime)
{
	...
	render_string(0x8000,2,Closeup_icon->closeup_label,GR_RESIZE_MENU);
//	brief_render_closeup_text();
...
void brief_render(float frametime)
{
	...
	if (Game_mode & GM_MULTIPLAYER) {
		...
		render_string(Title_coords_multi[gr_screen.res][0], Title_coords_multi[gr_screen.res][1], buf, GR_RESIZE_MENU);
	} else {
