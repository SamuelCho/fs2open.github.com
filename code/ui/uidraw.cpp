...
void ui_hline(int x1, int x2, int y )
{
	...
	render_line(x1,y,x2,y,GR_RESIZE_MENU);
}

void ui_vline(int y1, int y2, int x )
{
	//gr_line(x,y1,x,y2,GR_RESIZE_MENU);
	render_line(x,y1,x,y2,GR_RESIZE_MENU);
}
...
void ui_rect( int x1, int y1, int x2, int y2 )
{
	...
	render_colored_rect( x1, y1, x2-x1+1, y2-y1+1, GR_RESIZE_MENU_NO_OFFSET );
}
...
void ui_draw_box_out( int x1, int y1, int x2, int y2 )
{
	...
	render_colored_rect( x1+2, y1+2, (x2-2)-(x1+2)+1, (y2-2)-(y1+2)+1, GR_RESIZE_MENU_NO_OFFSET );
