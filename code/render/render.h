...
void render_bitmap_blended(int texture, float alpha, int _x, int _y, int resize_mode = GR_RESIZE_FULL);
...
void render_bitmap_uv(int texture, int _x, int _y, int _w, int _h, float _u0, float _v0, float _u1, float _v1, int resize_mode);
