...
// 	g3_draw_htl_line(&far_bottom_left, &far_top_left);
	...
	render_line_3d(true, &near_bottom_left, &near_bottom_right);
 	render_line_3d(true, &near_bottom_right, &near_top_right);
 	render_line_3d(true, &near_bottom_right, &near_top_left);
 	render_line_3d(true, &near_top_right, &near_top_left);
 	render_line_3d(true, &far_top_left, &far_top_right);
 	render_line_3d(true, &far_top_right, &far_bottom_right);
 	render_line_3d(true, &far_bottom_right, &far_bottom_left);
 	render_line_3d(true, &far_bottom_left, &far_top_left);
}
